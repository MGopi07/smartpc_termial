...
export const SliderGameSection = ({ section, games, onGameClick }) => {
    ...
    <div className="w-full max-w-[1800px] mx-auto px-4">
      ...
      <div className="flex items-center justify-between mb-3">
        <div className="flex items-center gap-2">
          {section.icon ? (
            <div className="w-6 h-6 rounded-full overflow-hidden bg-slate-800 flex items-center justify-center border border-white/10">
              {React.createElement(LucideIcons[section.icon] || LucideIcons.Gamepad2, { size: 14, className: "text-white" })}
            </div>
          ) : (
