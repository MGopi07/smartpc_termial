...
export const HotGameSection = ({ section, games, onGameClick }) => {
    ...
    <div className="w-full max-w-[1800px] mx-auto px-4">
        ...
        <div className="flex items-center gap-2">
          {section.icon ? (
            <div className="w-6 h-6 rounded-full overflow-hidden flex items-center justify-center">
              {React.createElement(LucideIcons[section.icon] || LucideIcons.Flame, { size: 20, className: "text-[#e11d48]" })}
            </div>
          ) : (
      ...
      >
        {games.map((game) => (
          ...
          >
            {/* Using aspect-square to make the cards taller specifically for Hot Games */}
